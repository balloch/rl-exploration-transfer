...
from rlexplore.poly_rl.poly_rl_policy import PolyRLDDPGPolicy, DDPGPolicy
...
if __name__ == "__main__":
    ...
    model = DDPG(
        policy=PolyRLDDPGPolicy if args.poly_rl else DDPGPolicy,
        env=env,
        verbose=1,
        action_noise=action_noise if not args.poly_rl else None,
        # learning_rate=0.001,
        # n_steps=2048,
        # batch_size=256,
        # n_epochs=4,
