...
from rib_ppo import RelationalActorCritic
...
def get_args():
    ...
    parser.add_argument("--rib", type=bool, default= RIB)
...
if __name__ == "__main__":
    ...
    model_name = f"{args.env_id.lower().replace('-', '_')}{'_rib' if args.rib else ''}_cnn_ppo_{args.total_time_steps}_{timestamp}"
