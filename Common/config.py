...
def get_params():
    ...
    parser.add_argument("--mem_size", default=int(1e+4), type=int, help="The memory size.")
    parser.add_argument("--n_skills", default=10, type=int, help="The number of skills to learn. Used to be 50")
